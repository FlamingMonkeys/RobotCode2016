...
public class OI {
    ...
    public JoystickButton driveStraightTrigger;
    public Joystick operatorJoy;
	public JoystickButton shiftTrigger;
	public JoystickButton goalFindTrigger;
...
//	    goalFindTrigger = new JoystickButton(operatorJoy,3);
//	    goalFindTrigger.whenPressed(new MoveToAim());
        
        shiftTrigger = new JoystickButton(driveJoy, 5);
        shiftTrigger.whenPressed(new ShiftGear());
        driveStraightTrigger = new JoystickButton(driveJoy, 6);
        driveStraightTrigger.whenPressed(new DriveStraight());
	...
	public double getTurnVal() {
		...
		return driveJoyRight.getRawAxis(0);
	}
	
	public double getTarget() {
		double target = operatorJoy.getRawAxis(1)*2; //invert so positive value goes up
		/*if(target>0){
			target -=.3;
